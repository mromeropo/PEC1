...
// Utility class to show books data in the app
object BooksFactory {

    // Returns a list of books
    // Replace with your favourite books if you'd like
    fun books(): List<Book> {
        return listOf(
            Book(
                1,
                ...
                "14/07/2015",
                "Go set a watchman",
                "https://www.wired.com/wp-content/uploads/2015/07/go-set-a-watchman-582x890.jpg"
            ),
            Book(
                2,
                "Paula Hawkins",
            ...
            Book(
                ...
                "3/02/2015",
                "The nightingale",
                "https://upload.wikimedia.org/wikipedia/en/b/b3/The_Nightingale_%282015_novel%29.jpg"
            ),
            Book(
                4,
                "Neil Gaiman",
                ...
                "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1415036119l/22522808.jpg"
            ),
            Book(
                5,
                "Pierce Brown",
                ...
                "06/01/2015",
                "Golden son",
                "https://hanabooktopia.com/wp-content/uploads/2019/02/goldeb-son.jpg"
            ),
            Book(
                6,
                "Dean Koontz",
                ...
                "13/01/2015",
                "Saint odd",
                "https://horrornovelreviews.files.wordpress.com/2015/02/saint-odd.jpeg"
            ),
            Book(
                7,
                "Mindy Kaling",
                ...
                "15/09/2015",
                "Why not me?",
                "https://di2ponv0v5otw.cloudfront.net/posts/2018/11/29/5bffcd063c98444a56db2cf6/m_5bffeb55df0307fec3f35bb5.jpeg"
            ),
            Book(
                8,
                ...
                "16/06/2015",
                "Modern Romance",
                "https://www.libertybooks.com/image/catalog/MZ.jpg"
            ),
            Book(
                9,
                ...
                "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1426127539i/23014804._UY475_SS475_.jpg"
            )
        )
    }

    // Returns a random book from the getBooks function
    fun randomBook(): Book {
        return books().random()
    }
}